...
export default class SNES extends React.Component {
  constructor(props) {
    super(props);
  }
        ...
        <View style={Styles.containerStyles.containerCenter}>
          ...
          <View style={Styles.containerStyles.containerAB}>
            <View style={{ flexDirection: 'row' }}>
              {this.getHiddenPlaceholder()}
              <Button
                title={Config.XButton.text}
                buttonStyle={Styles.buttonStyles.xButton}
                onPressIn={() => this.handleButtonClick(Config.XButton.keyId)}
                onPress={NOOP}
              />
              {this.getHiddenPlaceholder()}
            </View>
            <View style={{ flexDirection: 'row' }}>
              <Button
                title={Config.YButton.text}
                buttonStyle={Styles.buttonStyles.yButton}
                onPressIn={() => this.handleButtonClick(Config.YButton.keyId)}
                onPress={NOOP}
              />
              {this.getHiddenPlaceholder()}
              <Button
